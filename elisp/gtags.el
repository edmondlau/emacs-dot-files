...
(defvar gtags-language-hosts
  '(;("c++" . (("gtags.example.com" . 2223)))
    ...
    ("python" . (("ec2-184-72-6-45.us-west-1.compute.amazonaws.com" . 7225))))
...
(defvar gtags-call-graph-hosts
  '(;("c++" . (("gtags.example.com" . 2223)))
    ;("java" . (("gtags.example.com" . 2224)))
    ("python" . (("ec2-184-72-6-45.us-west-1.compute.amazonaws.com" . 7226))))
...
(defvar gtags-source-root "/home/edmond/ans"
